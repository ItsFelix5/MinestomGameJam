...
public class ThrownTrident extends AbstractArrow {
    ...
    public ThrownTrident(@Nullable Entity shooter, ItemStack tridentItem, EnchantmentFeature enchantmentFeature) {
        ...
        EnchantmentList enchantments = tridentItem.get(ItemComponent.ENCHANTMENTS);
        if (enchantments != null) {
            ThrownTridentMeta meta = ((ThrownTridentMeta) getEntityMeta());
            meta.setLoyaltyLevel((byte) enchantments.level(Enchantment.LOYALTY));

            meta.setHasEnchantmentGlint(!enchantments.enchantments().isEmpty());
        }
    }
