...
public class CombatPlayerImpl extends Player implements CombatPlayer {
    ...
    protected void movementTick() {
        ...
        Chunk finalChunk = ChunkUtils.retrieve(instance, currentChunk, previousPhysicsResult.newPosition());
        if (!ChunkUtils.isLoaded(finalChunk)) return;

        velocity = previousPhysicsResult.newVelocity().mul(tps);
        onGround = previousPhysicsResult.isOnGround();
